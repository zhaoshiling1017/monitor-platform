            ...
            if (null != ss) {
                while (true) {
                    try {
                        ...
                        String imagePath = dynamicConfigService.getString("fault_image_path", "/data/image/fault/") + ExtStringUtil.batchNoGenerator("DIC.FAULT_IMAGE_NAME_GEN", "0", 4, redisTemplate) + dynamicConfigService.getString("fault_image_sufix", ".jpg");
                        ...
                        String params = new String(dataBytes, 0, resultLen);
