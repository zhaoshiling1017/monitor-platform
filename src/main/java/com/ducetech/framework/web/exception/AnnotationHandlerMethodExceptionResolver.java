package com.ducetech.framework.web.exception;

import com.ducetech.framework.exception.BaseRuntimeException;
import com.ducetech.framework.exception.DuplicateTokenException;
import com.ducetech.framework.exception.ValidationException;
...
public class AnnotationHandlerMethodExceptionResolver implements HandlerExceptionResolver, Ordered {
    ...
    private static final Logger logger = LoggerFactory.getLogger("com.ducetech.errors");
    ...
    public ModelAndView resolveException(HttpServletRequest request, HttpServletResponse response, Object aHandler, Exception e) {
        ...
        if (e instanceof HttpRequestMethodNotSupportedException) {
            ...
            if (!skipLog) {
                ...
                MDC.setContextMap(ServletUtil.buildRequestInfoDataMap(request, true));
